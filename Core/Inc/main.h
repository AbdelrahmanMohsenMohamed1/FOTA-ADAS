...
#define IR_LF_Left_Pin GPIO_PIN_0
#define IR_LF_Left_GPIO_Port GPIOB
#define IR_LF_Mid_Pin GPIO_PIN_1
#define IR_LF_Mid_GPIO_Port GPIOB
#define IR_LF_Right_Pin GPIO_PIN_2
#define IR_LF_Right_GPIO_Port GPIOB
...
#define JUMP_TO_APP_Pin GPIO_PIN_12
#define JUMP_TO_APP_GPIO_Port GPIOA
