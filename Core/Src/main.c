...
static void MX_GPIO_Init(void) {
	...
	GPIO_InitStruct.Pin = mot1_in1_Pin | mot1_in2_Pin | mot2_in1_Pin
			| mot2_in2_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
	...
	/*Configure GPIO pins : IR_leftfront_Pin IR_midfront_Pin IR_rightfront_Pin IR1_Pin
	 DHT_Pin PB3 PB4 water_sensor_Pin */
	GPIO_InitStruct.Pin = IR_leftfront_Pin | IR_midfront_Pin | IR_rightfront_Pin
			| IR1_Pin | DHT_Pin | GPIO_PIN_3 | GPIO_PIN_4 | water_sensor_Pin;
